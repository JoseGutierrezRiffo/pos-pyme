...
export function ProfileSlideover({ user, onClose }: ProfileSlideoverProps) {
  ...
  async function save() {
    ...
    try {
      ...
      // Actualizar atom local para reflejar el cambio en toda la UI
      setCurrentUser({
        ...user,
      ...
      <div className="absolute inset-y-0 right-0 w-full sm:w-[28rem] bg-white shadow-2xl flex flex-col animate-slide-in-right">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-4">
            ...
            <div className="input bg-slate-50 cursor-not-allowed text-slate-500">{user.email}</div>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-500">Definido por el administrador</span>
            </div>
          </div>
